...
v0041_openapi_slurmdbd_jobs_resp_jobs_inner_time_form_dict = v0041_openapi_slurmdbd_jobs_resp_jobs_inner_time.from_dict(v0041_openapi_slurmdbd_jobs_resp_jobs_inner_time_dict)
```
