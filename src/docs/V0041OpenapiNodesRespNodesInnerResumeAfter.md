...
v0041_openapi_nodes_resp_nodes_inner_resume_after_form_dict = v0041_openapi_nodes_resp_nodes_inner_resume_after.from_dict(v0041_openapi_nodes_resp_nodes_inner_resume_after_dict)
```
