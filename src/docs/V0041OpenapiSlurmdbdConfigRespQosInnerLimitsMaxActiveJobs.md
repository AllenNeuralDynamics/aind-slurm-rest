...
v0041_openapi_slurmdbd_config_resp_qos_inner_limits_max_active_jobs_form_dict = v0041_openapi_slurmdbd_config_resp_qos_inner_limits_max_active_jobs.from_dict(v0041_openapi_slurmdbd_config_resp_qos_inner_limits_max_active_jobs_dict)
```
