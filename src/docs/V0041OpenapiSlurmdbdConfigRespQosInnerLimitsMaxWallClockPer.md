...
v0041_openapi_slurmdbd_config_resp_qos_inner_limits_max_wall_clock_per_form_dict = v0041_openapi_slurmdbd_config_resp_qos_inner_limits_max_wall_clock_per.from_dict(v0041_openapi_slurmdbd_config_resp_qos_inner_limits_max_wall_clock_per_dict)
```
