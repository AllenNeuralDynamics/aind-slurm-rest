...
v0041_openapi_job_info_resp_jobs_inner_suspend_time_form_dict = v0041_openapi_job_info_resp_jobs_inner_suspend_time.from_dict(v0041_openapi_job_info_resp_jobs_inner_suspend_time_dict)
```
