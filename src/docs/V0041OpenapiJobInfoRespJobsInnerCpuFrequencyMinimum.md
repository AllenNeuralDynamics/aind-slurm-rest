...
v0041_openapi_job_info_resp_jobs_inner_cpu_frequency_minimum_form_dict = v0041_openapi_job_info_resp_jobs_inner_cpu_frequency_minimum.from_dict(v0041_openapi_job_info_resp_jobs_inner_cpu_frequency_minimum_dict)
```
