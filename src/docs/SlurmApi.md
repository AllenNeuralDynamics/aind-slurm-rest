...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    job_id = 'job_id_example' # str | Job ID
    v0040_job_desc_msg = aind_slurm_rest.V0040JobDescMsg() # V0040JobDescMsg | Job update description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    v0040_job_submit_req = aind_slurm_rest.V0040JobSubmitReq() # V0040JobSubmitReq | Job description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    node_name = 'node_name_example' # str | Node name
    v0040_update_node_msg = aind_slurm_rest.V0040UpdateNodeMsg() # V0040UpdateNodeMsg | Node update description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    slurm_v0041_delete_jobs_request = aind_slurm_rest.SlurmV0041DeleteJobsRequest() # SlurmV0041DeleteJobsRequest | Signal or cancel jobs (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    job_id = 'job_id_example' # str | Job ID
    slurm_v0041_post_job_submit_request_jobs_inner = aind_slurm_rest.SlurmV0041PostJobSubmitRequestJobsInner() # SlurmV0041PostJobSubmitRequestJobsInner | Job update description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    slurm_v0041_post_job_allocate_request = aind_slurm_rest.SlurmV0041PostJobAllocateRequest() # SlurmV0041PostJobAllocateRequest | Job allocation description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    slurm_v0041_post_job_submit_request = aind_slurm_rest.SlurmV0041PostJobSubmitRequest() # SlurmV0041PostJobSubmitRequest | Job description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    node_name = 'node_name_example' # str | Node name
    slurm_v0041_post_node_request = aind_slurm_rest.SlurmV0041PostNodeRequest() # SlurmV0041PostNodeRequest | Node update description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    dbv0039_clusters_info = aind_slurm_rest.Dbv0039ClustersInfo() # Dbv0039ClustersInfo | Add or update clusters
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    dbv0039_wckey_info = aind_slurm_rest.Dbv0039WckeyInfo() # Dbv0039WckeyInfo | add wckeys (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    dbv0039_set_config = aind_slurm_rest.Dbv0039SetConfig() # Dbv0039SetConfig | Add or update config (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    dbv0039_account_info = aind_slurm_rest.Dbv0039AccountInfo() # Dbv0039AccountInfo | update/create accounts
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    dbv0039_associations_info = aind_slurm_rest.Dbv0039AssociationsInfo() # Dbv0039AssociationsInfo | Add or update associations
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    dbv0039_update_qos = aind_slurm_rest.Dbv0039UpdateQos() # Dbv0039UpdateQos | Add or update QOSs
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    dbv0039_tres_update = aind_slurm_rest.Dbv0039TresUpdate() # Dbv0039TresUpdate | Add or Update TRES
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmApi(api_client)
    dbv0039_update_users = aind_slurm_rest.Dbv0039UpdateUsers() # Dbv0039UpdateUsers | add or update user
