...
v0041_openapi_job_info_resp_jobs_inner_pre_sus_time_form_dict = v0041_openapi_job_info_resp_jobs_inner_pre_sus_time.from_dict(v0041_openapi_job_info_resp_jobs_inner_pre_sus_time_dict)
```
