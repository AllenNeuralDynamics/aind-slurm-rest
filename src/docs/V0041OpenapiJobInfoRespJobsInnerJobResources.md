...
v0041_openapi_job_info_resp_jobs_inner_job_resources_form_dict = v0041_openapi_job_info_resp_jobs_inner_job_resources.from_dict(v0041_openapi_job_info_resp_jobs_inner_job_resources_dict)
```
