...
slurm_v0041_post_job_submit_request_jobs_inner_form_dict = slurm_v0041_post_job_submit_request_jobs_inner.from_dict(slurm_v0041_post_job_submit_request_jobs_inner_dict)
```
