...
v0041_openapi_slurmdbd_jobs_resp_jobs_inner_array_form_dict = v0041_openapi_slurmdbd_jobs_resp_jobs_inner_array.from_dict(v0041_openapi_slurmdbd_jobs_resp_jobs_inner_array_dict)
```
