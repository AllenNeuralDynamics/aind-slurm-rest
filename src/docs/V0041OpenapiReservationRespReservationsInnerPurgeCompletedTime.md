...
v0041_openapi_reservation_resp_reservations_inner_purge_completed_time_form_dict = v0041_openapi_reservation_resp_reservations_inner_purge_completed_time.from_dict(v0041_openapi_reservation_resp_reservations_inner_purge_completed_time_dict)
```
