...
v0041_openapi_job_info_resp_jobs_inner_job_resources_threads_per_core_form_dict = v0041_openapi_job_info_resp_jobs_inner_job_resources_threads_per_core.from_dict(v0041_openapi_job_info_resp_jobs_inner_job_resources_threads_per_core_dict)
```
