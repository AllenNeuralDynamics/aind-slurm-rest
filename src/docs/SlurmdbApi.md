...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0040_openapi_accounts_resp = aind_slurm_rest.V0040OpenapiAccountsResp() # V0040OpenapiAccountsResp | Description of accounts to update/create (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0040_openapi_accounts_add_cond_resp = aind_slurm_rest.V0040OpenapiAccountsAddCondResp() # V0040OpenapiAccountsAddCondResp | Add list of accounts with conditional association (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0040_openapi_assocs_resp = aind_slurm_rest.V0040OpenapiAssocsResp() # V0040OpenapiAssocsResp | Job description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    update_time = 'update_time_example' # str | Filter reservations since update timestamp (optional)
    v0040_openapi_clusters_resp = aind_slurm_rest.V0040OpenapiClustersResp() # V0040OpenapiClustersResp | Cluster add or update descriptions (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0040_openapi_slurmdbd_config_resp = aind_slurm_rest.V0040OpenapiSlurmdbdConfigResp() # V0040OpenapiSlurmdbdConfigResp | Add or update config (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    preempt_mode = 'preempt_mode_example' # str | PreemptMode used when jobs in this QOS are preempted (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted QOS (optional)
    v0040_openapi_slurmdbd_qos_resp = aind_slurm_rest.V0040OpenapiSlurmdbdQosResp() # V0040OpenapiSlurmdbdQosResp | Description of QOS to add or update (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0040_openapi_tres_resp = aind_slurm_rest.V0040OpenapiTresResp() # V0040OpenapiTresResp | TRES descriptions. Only works in developer mode. (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0040_openapi_users_resp = aind_slurm_rest.V0040OpenapiUsersResp() # V0040OpenapiUsersResp | add or update user (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    flags = 'flags_example' # str | Query flags (optional)
    v0040_openapi_users_add_cond_resp = aind_slurm_rest.V0040OpenapiUsersAddCondResp() # V0040OpenapiUsersAddCondResp | Create users with conditional association (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    with_usage = 'with_usage_example' # str | Include usage (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted wckeys (optional)
    v0040_openapi_wckey_resp = aind_slurm_rest.V0040OpenapiWckeyResp() # V0040OpenapiWckeyResp | wckeys description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0041_openapi_accounts_resp = aind_slurm_rest.V0041OpenapiAccountsResp() # V0041OpenapiAccountsResp | Description of accounts to update/create (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    slurmdb_v0041_post_accounts_association_request = aind_slurm_rest.SlurmdbV0041PostAccountsAssociationRequest() # SlurmdbV0041PostAccountsAssociationRequest | Add list of accounts with conditional association (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0041_openapi_assocs_resp = aind_slurm_rest.V0041OpenapiAssocsResp() # V0041OpenapiAssocsResp | Job description (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    update_time = 'update_time_example' # str | Filter reservations since update timestamp (optional)
    v0041_openapi_clusters_resp = aind_slurm_rest.V0041OpenapiClustersResp() # V0041OpenapiClustersResp | Cluster add or update descriptions (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0041_openapi_slurmdbd_config_resp = aind_slurm_rest.V0041OpenapiSlurmdbdConfigResp() # V0041OpenapiSlurmdbdConfigResp | Add or update config (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    preempt_mode = 'preempt_mode_example' # str | PreemptMode used when jobs in this QOS are preempted (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted QOS (optional)
    v0041_openapi_slurmdbd_qos_resp = aind_slurm_rest.V0041OpenapiSlurmdbdQosResp() # V0041OpenapiSlurmdbdQosResp | Description of QOS to add or update (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0041_openapi_tres_resp = aind_slurm_rest.V0041OpenapiTresResp() # V0041OpenapiTresResp | TRES descriptions. Only works in developer mode. (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aind_slurm_rest.SlurmdbApi(api_client)
    v0041_openapi_users_resp = aind_slurm_rest.V0041OpenapiUsersResp() # V0041OpenapiUsersResp | add or update user (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    update_time = 'update_time_example' # str | Filter partitions since update timestamp (optional)
    flags = 'flags_example' # str | Query flags (optional)
    slurmdb_v0041_post_users_association_request = aind_slurm_rest.SlurmdbV0041PostUsersAssociationRequest() # SlurmdbV0041PostUsersAssociationRequest | Create users with conditional association (optional)
...
with aind_slurm_rest.ApiClient(configuration) as api_client:
    ...
    with_usage = 'with_usage_example' # str | Include usage (optional)
    with_deleted = 'with_deleted_example' # str | Include deleted wckeys (optional)
    v0041_openapi_wckey_resp = aind_slurm_rest.V0041OpenapiWckeyResp() # V0041OpenapiWckeyResp | wckeys description (optional)
