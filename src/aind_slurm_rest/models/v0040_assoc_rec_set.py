    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.grptresrunmins:
            for _item in self.grptresrunmins:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.maxtresminsperjob:
            for _item in self.maxtresminsperjob:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.maxtresrunmins:
            for _item in self.maxtresrunmins:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.maxtresperjob:
            for _item in self.maxtresperjob:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.maxtrespernode:
            for _item in self.maxtrespernode:
                if _item:
                    _items.append(_item.to_dict())
